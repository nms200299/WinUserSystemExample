/*
Title : ALL-IN-ONE Trampoline 후킹 테스트
Summary : 스스로의 함수 프롤로그를 조작하여 Trampoline 후킹을 테스트합니다.
*/ 
...
int _tmain() {	
	...
	#ifdef _WIN64
	int HookOpt = X64_14BYTE_STACK;	//	HookOpt = X64_12BYTE_REGSTER, X64_14BYTE_STACK, X64_14BYTE_RIP
	# else
	int HookOpt = X86_7BYTE;		//	HookOpt = X86_5BYTE, X86_7BYTE
	# endif
